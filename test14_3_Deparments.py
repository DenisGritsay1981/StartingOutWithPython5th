...
def display_menu():
    ...
    print("2.Вывести на экран все факультеты ")
    print("3.Обновить факультеты")
    print("4.Удалить факультет")
    print("5.Найти существующий факультет")
...
def create():
    print("Добавить новый факультет")
    name = input("Название факультета: ")
    insert_row(name)
def insert_row(name):
    conn = None
    try:
...
def delete():
    print("Вот данные таблицы Departments")
    read()
    print("Вот данные таблицы Students")
    read_students()
    print("Удаление строки из таблицы Departments не должно совпадать с налицием ее в Students")
    select_id = int(input("Выберете ID обновляемой позиции"))
